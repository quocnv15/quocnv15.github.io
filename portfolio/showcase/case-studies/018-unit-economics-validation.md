...
> **Public-safe note:** Exact revenue, spend, and ROI figures are redacted. Full metrics stay private in `ios-memory`.
...
- App 006: Paid acquisition near break-even → **do not scale yet**
- App 009: Early IAP traction → **watch, do not over-invest**
- App 010: Strong early efficiency signal → **candidate to scale carefully**
...
**Tại sao?**
- Near break-even unit economics (App 006) → **do not scale**
- Strong payback signal (App 010) → **scale carefully**
...
**AI nói:** "Standard IAP tiers: low / mid / high price points"
...
- App 010: Early conversion shows impulse pricing can work
...
**Evidence:**
- App 010 launched "imperfect" → strong early efficiency signal
...
| App | Signal | Stance | Status |
|-----|--------|--------|--------|
| **006** | Near break-even on paid | Do not scale yet | ⚠️ Optimize |
| **009** | Early IAP traction | Watch / learn | 🔄 Early |
| **010** | Strong early efficiency | Scale carefully | 🚀 Candidate |
...
**Direct outcomes (numbers private):**
- Identified a star-pattern app vs break-even apps
- Avoided scaling the weak unit-economics candidate
- Clarity on stop / scale signals without gut feeling
