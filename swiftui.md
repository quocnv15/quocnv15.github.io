...
<style>
  ...
  .swiftui-hero {
    background: linear-gradient(135deg, #FF5E3A 0%, #FF2A68 50%, #B339A3 100%);
  ...
  .swiftui-card {
    ...
    overflow: hidden;
    position: relative;
    transition: transform 0.25s cubic-bezier(0.175, 0.885, 0.32, 1.15), box-shadow 0.25s ease, border-color 0.25s ease;
  }
  ...
  .swiftui-card:hover .card-media img {
  ...
  .card-gradient-placeholder::after {
    content: 'SwiftUI';
    position: absolute;
    bottom: var(--space-xs);
    right: var(--space-sm);
  ...
  /* Specific category gradient mappings for placeholders */
  .placeholder-text_typography { background: linear-gradient(135deg, #8E2DE2 0%, #4A00E0 100%); }
  .placeholder-animations_loaders { background: linear-gradient(135deg, #00c6ff 0%, #0072ff 100%); }
  .placeholder-buttons_interaction { background: linear-gradient(135deg, #f857a6 0%, #ff5858 100%); }
  .placeholder-pickers_selection { background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); }
  .placeholder-ui_layouts { background: linear-gradient(135deg, #F3904F 0%, #3B4371 100%); }
  .placeholder-visual_effects_3d { background: linear-gradient(135deg, #f4c4f3 0%, #fc67fa 100%); }
  .placeholder-forms_inputs { background: linear-gradient(135deg, #61aa2a 0%, #3b5e2b 100%); }
  .placeholder-lists_alerts_progress { background: linear-gradient(135deg, #FF4B2B 0%, #FF416C 100%); }
  .placeholder-concepts_tutorials { background: linear-gradient(135deg, #1D976C 0%, #93F9B9 100%); }
  .placeholder-premium_advanced { background: linear-gradient(135deg, #f9d423 0%, #ff4e50 100%); }
  .placeholder-games_media { background: linear-gradient(135deg, #43c6ac 0%, #191654 100%); }
  .placeholder-other { background: linear-gradient(135deg, #757f9a 0%, #d7dde8 100%); }
...
<div class="swiftui-page">
  ...
  <div style="margin-bottom: var(--space-md);">
    <a href="/portfolio/" class="portfolio-back-bar__link" style="padding-left: 0;">
  ...
  <section class="swiftui-hero">
    ...
    <div class="swiftui-hero__stats">
      ...
      <div class="swiftui-hero__stat-item" style="opacity: 0.85;">
      ...
      <div class="swiftui-hero__stat-item" style="opacity: 0.85;">
        <span>🏗️ <b>{{ other_count }}</b> Kavsoft</span>
      </div>
    </div>
  </section>
